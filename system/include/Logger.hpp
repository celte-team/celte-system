...
// Singleton accessor renamed to REDISDB for clarity
#define REDISDB celte::RedisDb::GetInstance()

#ifndef RELEASE
#define LOGDEBUG(message)                                                      \
  celte::RedisDb::GetInstance().Log(celte::RedisDb::LogLevel::DEBUG, message)
...
#define LOGWARNING(message)                                                    \
  celte::RedisDb::GetInstance().Log(celte::RedisDb::LogLevel::WARNING, message)
#define LOGERROR(message)                                                      \
  celte::RedisDb::GetInstance().Log(celte::RedisDb::LogLevel::ERROR, message)
