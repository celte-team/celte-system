...
namespace celte {
    struct HookTable {
        ...
        std::function<std::string(const std::string&)> onGetClientInitialGrape = UNIMPLEMENTED<std::string, const std::string&>;
        ...
        std::function<void(const std::string&)> onAcceptNewClient = UNIMPLEMENTED<void, const std::string&>;

        std::function<void(const std::string&)> onClientRequestDisconnect = UNIMPLEMENTED<void, const std::string&>;
        ...
        /// @param clientId The unique identifier of the client.
        std::function<void(std::string, std::string)> onClientDisconnect = UNIMPLEMENTED<void, std::string, std::string>;

        /// @brief Called when a grape is loaded (the game should load the map and the
        /// CSN object associated with it).
        std::function<void(std::string, bool)> onLoadGrape = UNIMPLEMENTED<void, std::string, bool>;
        ...
        std::function<void(std::string, std::string)> onInstantiateEntity = UNIMPLEMENTED<void, std::string, std::string>;

        /// @brief Called when an entity has to be deleted in the engine.
        /// @param entityId The unique identifier of the entity.
        /// @param payload The payload of the entity.
        std::function<void(std::string, std::string)> onDeleteEntity = UNIMPLEMENTED<void, std::string, std::string>;
