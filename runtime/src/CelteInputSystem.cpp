...
namespace celte {
    namespace runtime {
        ...
        std::shared_ptr<std::map<std::string, std::map<std::string, boost::circular_buffer<CelteInputSystem::DataInput_t>>>> CelteInputSystem::getListInput()
        {
            return std::make_shared<LIST_INPUTS>(_data);
        }
