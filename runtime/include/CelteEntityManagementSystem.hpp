...
namespace celte {
    namespace runtime {
        ...
        public:
             ...
             */
            std::optional<std::shared_ptr<celte::CelteEntity>> GetEntity(const std::string& uuid) const;
        ...
        private:
            ...
            std::unordered_map<std::string, bool (CelteEntityManagementSystem::*)(const std::string&) const>
                _filters = {
