...
namespace celte {
    namespace rpc {
        ...
        class Table {
        public:
            using RemoteProcedure = std::function<void(kafka::clients::consumer::ConsumerRecord,
                ...
                RemoteProcedure call =
                    [this, rpc](kafka::clients::consumer::ConsumerRecord consumerRecord,
                        ...
                        try {
                            ...
                            auto record = __createResultProducerRecord(*peerUUID, *rpcUUID, result);
        ...
        private:
            ...
            {
                __send(record, [rpcUUID, peerUUID, serializedResult](const kafka::clients::producer::RecordMetadata&, kafka::Error err) {
                    if (err) {
                        logs::Logger::getInstance().err()
