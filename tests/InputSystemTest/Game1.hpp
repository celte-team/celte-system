#ifndef D1CB78CE_5A5E_4ED8_A9A9_DE707C9989E2
#define D1CB78CE_5A5E_4ED8_A9A9_DE707C9989E2
...
public:
    ...
    void LoadArea(const std::string name, bool locallyOwned)
    {
        ...
        auto grapeOptions = celte::chunks::GrapeOptions { .grapeId = name,
            .subdivision = 1,
...
#endif /* D1CB78CE_5A5E_4ED8_A9A9_DE707C9989E2 */
